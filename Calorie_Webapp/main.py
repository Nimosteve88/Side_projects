...
class CaloriesFormPage(MethodView):
    ...
    def post(self):
        #initialises classes in order to get the temperature and
        # calories through their get() function
        calories_form = CaloriesForm(request.form)
        temperature = Temperature(calories_form.country.data,
                                  calories_form.city.data).get()
...
class CaloriesForm(Form):
    ...
    height = StringField("Weight: ", default=175)
