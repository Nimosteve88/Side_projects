...
class BillFormPage(MethodView):
    ...
    def post(self):
        ...
        days_in_house1 = billform.days_in_house1

        the_bill = flat.Bill(float(billform.amount.data), billform.period.data)
        flatmate1 = flat.Flatmate(billform.name1.data, float(billform.days_in_house1.data))  # Instantiated classes
        # in order easily print results
...
class BillForm(Form):
    ...
    name2 = StringField("Name: ", default="Sam")
